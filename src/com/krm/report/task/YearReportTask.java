 ...
 * @date 2018-07-11
 */
public class YearReportTask implements Runnable {

	private static Logger log = LoggerFactory.getLogger(YearReportTask.class);
	private String ticket = "";
	private String exportDate;
	private OrganVo organVo;
	private List<FormVo> formVoList;

	public YearReportTask(String exportDate, OrganVo organVo,
		...
		try {
			for (int reportCount = 0; reportCount < formVoList.size(); reportCount++) {
				...
				try {
					...
					String filepath = "/conf/dayReportExportFailedReport.txt";
			...
			// 记录这家机构导出成功
			String filepath = "/conf/dayReportExportSuccessOrgan.txt";
			StringBuffer content = new StringBuffer();
